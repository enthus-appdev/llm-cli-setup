...
export const configureLlmTools = async () => {
  ...
  console.log(
    chalk.gray('This teaches LLMs how to use sqlcmd, gh, atl, n8nctl, and grafanactl.\n')
  );
  ...
  console.log(
    chalk.gray('Your AI assistants now know how to use sqlcmd, gh, atl, n8nctl, and grafanactl!')
  );

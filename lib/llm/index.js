...
atl confluence page view --space DOCS --title "Page Title"  # Exact title match only
atl confluence page search --query "search term"
...
atl confluence page children <parent-id>    # List child pages
\`\`\`

**Tip**: When exploring page hierarchies, use \`children\` command with page IDs. Title search requires exact matches, so prefer IDs when navigating.

...
export const configureLlmTools = async () => {
  ...
  console.log(chalk.gray('This teaches LLMs how to use sqlcmd, sql-env, gh, atl, and n8nctl.\n'));
  ...
  console.log(chalk.gray('Your AI assistants now know how to use sqlcmd, sql-env, gh, atl, and n8nctl!'));

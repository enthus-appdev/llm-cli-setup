...
atl --context prod jira issue comment add PROJ-1234 --reply-to <id> --body "Reply"
...
Jira issue comments are flat rather than threaded. After upgrading to an atl release newer than v1.13.0, \`--reply-to <comment-id>\` creates a new comment containing a real mention of the original author and a focused link to the original comment. It does not quote or duplicate the original body:

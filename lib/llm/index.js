...
discordctl msg send <channel> "text"            # Post a message (auto-prefixes displayName, auto-reacts personalEmoji)
...
Messages sent via \`msg send\` are automatically personalized:
- **displayName** — prepended as bold text (e.g. "**YourName** — Stage GUI")
- **personalEmoji** — auto-reacted on the message for quick visual identification
...
export const configureLlmTools = async () => {
  ...
  console.log(
    chalk.gray(
      'This teaches LLMs how to use sqlcmd, gh, atl, n8nctl, grafanactl, logcli, m365, esq, and discordctl.\n'
    )
  );
  ...
  console.log(
    chalk.gray(
      'Your AI assistants now know how to use sqlcmd, gh, atl, n8nctl, grafanactl, logcli, m365, esq, and discordctl!'
    )
  );

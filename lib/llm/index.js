...
const BLOCK_START_CLAUDE = '<!-- === Enthus CLI Tools === -->';
const BLOCK_END_CLAUDE = '<!-- === End Enthus CLI Tools === -->';
const BLOCK_START_CODEX = '# === Enthus CLI Tools ===';
const BLOCK_END_CODEX = '# === End Enthus CLI Tools ===';

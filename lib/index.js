...
import { installSqlcmd, configureSqlEnv, configureGitHubCli, configureAtlassianCli, configureN8nCli } from './installers/index.js';
...
export const configureShellEnv = async () => {
  ...
  console.log(chalk.cyan('  n8n workflow list    # List n8n workflows'));
  console.log(chalk.cyan('  n8n workflow pull <id> -r  # Pull workflow with sub-workflows'));
};

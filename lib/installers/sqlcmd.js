...
const OLD_LEGACY_BLOCK_START = '# === NegSoft SQL Environment Switcher ===';
const OLD_LEGACY_BLOCK_END = '# === End NegSoft SQL Environment Switcher ===';
...
const cleanupOldInstallation = () => {
  ...
  if (profileContent.includes(OLD_LEGACY_BLOCK_START)) {
    profileContent = removeBlock(profileContent, OLD_LEGACY_BLOCK_START, OLD_LEGACY_BLOCK_END);
    cleaned = true;
  }
...
const hasOldInstallation = () => {
  ...
  return (
    ...
    profileContent.includes(OLD_LEGACY_BLOCK_START) ||

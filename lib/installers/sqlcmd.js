...
/**
 * Check sqlcmd installation status
 */
export const installSqlcmd = async () => {
  ...
  console.log(chalk.gray('Install go-sqlcmd:'));
  console.log(chalk.gray('  brew install sqlcmd    # macOS/Linux/WSL'));
  console.log(chalk.gray('  winget install sqlcmd  # Windows'));
  return false;
};

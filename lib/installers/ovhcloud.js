...
// install.sh drops the binary here without touching PATH; prepend it for this
// process so a freshly-installed ovhcloud resolves immediately (detection + login).

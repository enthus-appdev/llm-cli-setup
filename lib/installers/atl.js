...
// Repository for atl-cli - must be configured via environment variable
export const ATL_CLI_REPO = process.env.ATL_CLI_REPO || null;
...
const installAtl = async () => {
  ...
  if (!ATL_CLI_REPO) {
    console.log(chalk.yellow('ATL_CLI_REPO environment variable is not set.'));
    console.log(chalk.gray('Set it to your atl-cli repository, e.g.:'));
    console.log(chalk.gray('  export ATL_CLI_REPO="your-org/atl-cli"'));
